  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        {/* Top Marker Strip: 15 / 30 & Technical Indicators */}
        <div className="flex items-center justify-between pb-8 mb-12 sm:mb-16 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs text-[#A6A6A0] tracking-widest uppercase">
              MARCADOR DE MEIO DE CICLO // VIRADA DE CONSISTÊNCIA
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 relative z-20">
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-[5.5rem] xl:text-[6.8rem] font-black tracking-[-0.045em] text-[#F5F5F0] uppercase font-display leading-[0.93] sm:leading-[0.91] select-none">
              MENOS <br />
              <span className="text-[#A6A6A0]/40">DÚVIDA.</span> <br />
              <span className="mt-2 block">
                <span className="text-[#F5F5F0]">MAIS </span> <br />
                <span className="text-[#B8F23D] tracking-[-0.03em]">CONSISTÊNCIA.</span>
              </span>
            </h2>

            <p className="mt-10 text-lg sm:text-2xl text-[#A6A6A0] max-w-xl font-normal leading-relaxed">
              Você não precisa esperar pela motivação todos os dias. Quando existe um plano claro, o treino vira hábito automático — e o resultado se torna inevitável.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <button
                ...
                className="btn-premium-primary px-8 sm:px-10 py-4.5 sm:py-5 rounded-full text-xs sm:text-sm font-black uppercase tracking-wider gap-3 cursor-pointer group shadow-2xl"
              >
                <span>Garantir minha vaga no programa</span>
                <ArrowRight className="w-4 h-4 text-[#080808] transition-transform duration-200 group-hover:translate-x-1" />
              </button>

              <span className="font-mono text-xs text-[#A6A6A0] uppercase tracking-wider">
                PROGRAMA 30 DIAS // VAGAS LIMITADAS
              </span>
            </div>
          </div>

          {/* High-Fashion Athletic Photography Partially Overlaid (5 cols) */}
          <div className="lg:col-span-5 relative mt-6 lg:mt-0 z-10">
            ...
            <div className="aspect-[3/4] sm:aspect-[4/5] rounded-3xl overflow-hidden bg-[#111111] border border-white/10 shadow-2xl relative group">
              ...
              {/* Minimalist HUD metadata overlay */}
